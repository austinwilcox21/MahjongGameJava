...
public class DemoTile extends JFrame
{
    ...
    static
    {
        ...
        GRAD1 = new GradientPaint(20, 100, Color.WHITE, 120, 0, Color.RED);
        GRAD2 = new GradientPaint(10, 110, Color.WHITE, 20, 0, Color.RED);
